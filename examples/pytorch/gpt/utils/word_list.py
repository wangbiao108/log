...
def test_csv_read_write():
    ...
    #test_words = [["i like tiger"], ["In the last couple of days, a lot of people have been asking me about"],  ["Bird will fly"], ["In the last couple of days"]]
    test_words = [["In the last couple of days, a lot of people have been asking me about, student learn engish"],["In the last couple of days"]]
    print(f"\n[seq]: {test_words}")
