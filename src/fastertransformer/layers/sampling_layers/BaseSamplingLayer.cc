...
{
    printf("-----------sampling_layer.vocab_size_=%d,%d,  sampling_layer.sampling_workspace_size_=%d\n", 
        sampling_layer.vocab_size_,
        sampling_layer.vocab_size_padded_,
        sampling_layer.sampling_workspace_size_);
}
