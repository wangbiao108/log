...
{
    printf("[%s:%d-pid:%d-%s]: <... begin ...> hidden_units_=%d int8_mode_=%d inter_size_=%d tensor_para_size_=%d tensor_para_rank_=%d gpt_variant_params_{%d,%d,%d,%d,%d,%d,%d]\n", 
...
void ParallelGptDecoderLayerWeight<T>::loadModel(std::string dir_path, FtCudaDataType model_file_type)
{
    ...
    printf("[%s:%d-pid:%d-%s]: <... begin ...> model_file_type=%d FP32-%d FP16-%d INT8-%d hidden_units_=%d int8_mode_=%d\n", 
        __FUNCTION__, __LINE__, getpid(),__FILENAME__,
        (int32_t)model_file_type,
        (int32_t)FtCudaDataType::FP32,
        (int32_t)FtCudaDataType::FP16, 
        (int32_t)FtCudaDataType::INT8, 
        hidden_units_, int8_mode_);
...
void ParallelGptDecoderLayerWeight<T>::setWeightPtr()
{
    printf("[%s:%d-pid:%d-%s]: <... begin ...> hidden_units_=%d int8_mode_=%d inter_size_=%d tensor_para_size_=%d tensor_para_rank_=%d gpt_variant_params_{%d,%d,%d,%d,%d,%d,%d]\n", 
        __FUNCTION__, __LINE__, getpid(),__FILENAME__,
        hidden_units_, int8_mode_, inter_size_, 
    ...
    printf("[%s:%d-pid:%d-%s]: <... 0~19 ...> weights_ptr[12]=%p weights_ptr[16]=%p\n", 
        __FUNCTION__, __LINE__, getpid(),__FILENAME__,
        weights_ptr[12],weights_ptr[16]);
