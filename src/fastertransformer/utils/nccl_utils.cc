...
{
    printf("ftNcclInitialize: begin... tensor_para_size:%d pipeline_para_size:%d \n",
        tensor_para_size,
        pipeline_para_size);
    ...
    printf("++++ftNcclInitialize: rank=%d tp_rank=%d pp_rank=%d \n",
        rank,
        tp_rank,
        pp_rank);
    ...
    printf("tensor_para_size=%d, tp_rank=%d tp_uid=%d\n",tensor_para_size, tp_rank,tp_uid);
    ...
    printf("++++ftNcclInitialize: %d %d %d %d \n",
        tensor_para.rank_,
